...
echo "git branch --set-upstream-to=upstream/trunk trunk # error expected"
echo "git config --local -l"
echo
echo "# Fetch from upstream and push to origin~fork"
echo "git pull upstream develop"
echo "git branch --set-upstream-to=upstream/trunk trunk"
echo
...
echo
echo "git fetch upstream trunk"
echo "git rebase upstream/trunk"
echo "git log"
